#' gln: A package for analysis of variance(ANOVA).
#'
...
#'
#'
#' @author Meng Lan   menglan36@gmail.com,
#'
#'         Xinye Gui  leafly80@163.com,
#'
#'         Yuwei Ni   yuweiniCornell@gmail.com
#'
#' @section gln functions:
#'
#' @docType package
#' @name gln
NULL
